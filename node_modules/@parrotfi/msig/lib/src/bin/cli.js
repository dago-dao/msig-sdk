...
(0, utils_1.setupJSONPrint)();
// require("dotenv").config();
let ENV = {
    multisigProgram: new web3_js_1.PublicKey(process.env.MULTISIG_PROGRAM ||
...
cli
    ...
    const rProposals = require((0, path_1.join)(process.cwd(), ENV.proposalDir, proposals));
    await (0, batchCreate_1.batchCreateProposals)(await (0, utils_1.getMultisigContext)((0, utils_1.getProgramFromEnv)(ENV), rProposals.multisig), rProposals.transactions, opts.smallTx, opts.dryRun);
});
cli
    .command("verify")
